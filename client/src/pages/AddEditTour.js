...
const AddEditTour = () => {
  ...
  const { title, description, tags, file } = tourData;
  ...
  }, [id]);//this will put values in the form
  ...
  const handleSubmit = (e) => {
    ...
    if (title && description && tags && file.length > 5) {
  ...
  const handleClear = () => {
    setTourData({ title: "", description: "", tags: [], file: "" });
  };
          ...
          <MDBValidation onSubmit={handleSubmit} className="row g-3" noValidate>
            ...
            <div className="d-flex justify-content-start">
              <FileBase
                ...
                multiple={false}
                onDone={({ base64 }) => {
                  setTourData({ ...tourData, file: base64 })
                }
                }
              />
            </div>
